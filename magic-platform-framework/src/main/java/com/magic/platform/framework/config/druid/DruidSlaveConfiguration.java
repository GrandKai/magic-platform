...
import com.magic.platform.support.properties.MySQLSlaveProperties;
...
@EnableConfigurationProperties({MySQLSlaveProperties.class, DruidProperties.class})
public class DruidSlaveConfiguration {

    public static final String DATASOURCE_NAME = "druidSlaveDataSource";
     ...
     * @return
     */
    @Bean(name = "druidSlaveStateViewServlet")
    ...
    @Bean(name = "druidSlaveWebStateFilter")
...
//    @Primary
    @Bean(name = DruidSlaveConfiguration.DATASOURCE_NAME)
    public DataSource druidDataSource() {
        DruidDataSource dataSource = new DruidDataSource();
        dataSource.setUrl(mySQLSlaveProperties.getUrl());
        dataSource.setDriverClassName(mySQLSlaveProperties.getDriverClassName());
        dataSource.setUsername(mySQLSlaveProperties.getUsername());
        dataSource.setPassword(mySQLSlaveProperties.getPassword());
